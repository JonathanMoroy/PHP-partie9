...
<html>
    ...
    <body>
        ...
        <p>
            Affichage de la date du jour moins 22 jours:
            <?php
            // utilisation de date pour afficher la date à laquelle on soustrait 22 jours par strtotime
            $beginDate = '2017-05-12';
            echo date('Y-m-d', strtotime($beginDate . ' -22 days'));
            ?>
        </p>
    </body>
</html>